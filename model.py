...
class lowlight_enhance(object):
    ...
    def test(self, test_low_data, test_high_data, test_low_data_names, save_dir, decom_flag):
        ...
        load_model_status_Decom, _ = self.load(self.saver_Decom, '/content/RetinexNet/model/Decom')
        load_model_status_Relight, _ = self.load(self.saver_Relight, '/content/RetinexNet/model/Relight')
